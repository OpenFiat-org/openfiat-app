...
- [ ] Land core architecture / directory structure (this bootstrap)
- [ ] Wire up CI to green on `main`
- [ ] Fill in first-pass implementation for the primary module(s)
- [ ] Publish first `0.1.0` pre-release

## Mid term

- [ ] Stabilize public interfaces referenced by other OpenFiat-org repositories
- [ ] Expand automated test coverage (unit, integration, and where
      applicable conformance vectors from `openfiat-conformance`)
- [ ] Publish versioned documentation

## Long term

- [ ] Reach API/protocol stability commitments appropriate for a `Application`
      component
