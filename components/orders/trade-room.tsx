    ...
    <div className="grid gap-6 lg:grid-cols-[1.6fr_1fr]">
      <div className="space-y-6">
        ...
        <p className="border-l-2 border-amber-400/60 bg-amber-400/5 px-4 py-3 text-xs leading-relaxed text-amber-200">
          This interface only displays what the node reports for this trade — it
          does not yet submit payment confirmations, approvals, cancellations,
          or dispute filings. Those are signed protocol events (
          <code className="font-mono">sendPaymentSubmitted</code>,{" "}
          <code className="font-mono">sendSettlementApproved</code>,{" "}
          <code className="font-mono">sendDisputeOpen</code>, …) this build
          doesn&apos;t construct and send yet.
        </p>
        ...
        <Panel title="Reservation">
          <div className="divide-y divide-white/5 px-4">
            ...
            <Row
              label="Requester"
              value={label(reservation.requester, iAmRequester)}
            />
            ...
            <div className="divide-y divide-white/5 px-4">
              ...
              {settlement.payment_reference && (
                <Row
                  ...
                  value={settlement.payment_reference}
                />
              )}
