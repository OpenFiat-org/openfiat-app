...
export const ADS: Advertisement[] = [
  ...
  { id: "AD-1001", merchantId: "m-kenyastar", asset: "USDT", direction: "Sell", fiatCurrency: "KES", pricing: fixed(132.45), minTrade: 38, maxTrade: 3780, availableLiquidity: 25430.5, paymentMethods: [MPESA, EQUITY], terms: "Send from an account in your own name — third-party transfers are rejected and refunded. Use the trade ID as the M-Pesa reference. I settle 07:00–22:00 EAT.", status: "Online", updatedAt: "2026-07-27T13:58:00Z" },
  { id: "AD-1002", merchantId: "m-swiftkes", asset: "USDT", direction: "Sell", fiatCurrency: "KES", pricing: floating(0.8), minTrade: 15, maxTrade: 1890, availableLiquidity: 12000, paymentMethods: [MPESA, POCHI, IM_BANK], minCounterpartyReputation: 65, terms: "Bank transfers only from a Kenyan account you hold. Put the trade ID in the reference field or I cannot match your payment. No cash deposits at the branch.", status: "Online", updatedAt: "2026-07-27T13:55:00Z" },
  { id: "AD-1003", merchantId: "m-westlands", asset: "USDT", direction: "Sell", fiatCurrency: "KES", pricing: fixed(132.9), minTrade: 75, maxTrade: 15000, availableLiquidity: 85000, paymentMethods: [EQUITY, KCB, IM_BANK], minCounterpartyReputation: 75, terms: "Large amounts welcome. For anything above 500,000 KES message me first so I can confirm the vault has the depth. Reference must be the trade ID.", status: "Online", updatedAt: "2026-07-27T13:51:00Z" },
  { id: "AD-1004", merchantId: "m-nairobihub", asset: "USDT", direction: "Sell", fiatCurrency: "KES", pricing: floating(1.1), minTrade: 7.5, maxTrade: 753, availableLiquidity: 4200.75, paymentMethods: [MPESA], status: "Online", updatedAt: "2026-07-27T13:47:00Z" },
  { id: "AD-1005", merchantId: "m-mombasapay", asset: "USDT", direction: "Sell", fiatCurrency: "KES", pricing: fixed(133.1), minTrade: 3.8, maxTrade: 451, availableLiquidity: 1850.2, paymentMethods: [MPESA, POCHI], status: "Online", updatedAt: "2026-07-27T13:40:00Z" },
  { id: "AD-1006", merchantId: "m-thika", asset: "USDC", direction: "Sell", fiatCurrency: "KES", pricing: fixed(131.8), minTrade: 23, maxTrade: 1140, availableLiquidity: 9600, paymentMethods: [MPESA, KCB], status: "Online", updatedAt: "2026-07-27T13:32:00Z" },
  { id: "AD-1007", merchantId: "m-kenyastar", asset: "USDC", direction: "Sell", fiatCurrency: "KES", pricing: floating(0.6), minTrade: 38, maxTrade: 3030, availableLiquidity: 31200, paymentMethods: [MPESA, EQUITY, IM_BANK], status: "Online", updatedAt: "2026-07-27T13:29:00Z" },
  { id: "AD-1008", merchantId: "m-nairobihub", asset: "USD1", direction: "Sell", fiatCurrency: "KES", pricing: fixed(131.95), minTrade: 15, maxTrade: 606, availableLiquidity: 5400, paymentMethods: [MPESA], status: "Paused", updatedAt: "2026-07-26T18:12:00Z" },
  { id: "AD-1009", merchantId: "m-westlands", asset: "SOL", direction: "Sell", fiatCurrency: "KES", pricing: floating(1.5), minTrade: 1, maxTrade: 46.8, availableLiquidity: 240.5, paymentMethods: [EQUITY, KCB], status: "Online", updatedAt: "2026-07-27T13:21:00Z" },
  { id: "AD-1010", merchantId: "m-lagosnaira", asset: "USDT", direction: "Sell", fiatCurrency: "NGN", pricing: fixed(1552), minTrade: 32, maxTrade: 5150, availableLiquidity: 62000, paymentMethods: [BANK_TRANSFER], status: "Online", updatedAt: "2026-07-27T13:18:00Z" },
  { id: "AD-1011", merchantId: "m-londondesk", asset: "USDT", direction: "Sell", fiatCurrency: "USD", pricing: floating(0.4), minTrade: 500, maxTrade: 249000, availableLiquidity: 480000, paymentMethods: [WISE, REVOLUT, SKRILL], status: "Online", updatedAt: "2026-07-27T13:15:00Z" },
  { id: "AD-1012", merchantId: "m-eurovault", asset: "USDC", direction: "Sell", fiatCurrency: "EUR", pricing: fixed(0.93), minTrade: 110, maxTrade: 53800, availableLiquidity: 76000, paymentMethods: [SEPA, REVOLUT], status: "Online", updatedAt: "2026-07-27T13:11:00Z" },
  { id: "AD-1013", merchantId: "m-mumbaiupi", asset: "USDT", direction: "Sell", fiatCurrency: "INR", pricing: floating(0.9), minTrade: 57, maxTrade: 5740, availableLiquidity: 22500, paymentMethods: [UPI], status: "Online", updatedAt: "2026-07-27T13:05:00Z" },
  { id: "AD-1014", merchantId: "m-saopix", asset: "USDT", direction: "Sell", fiatCurrency: "BRL", pricing: fixed(5.71), minTrade: 35, maxTrade: 10500, availableLiquidity: 18300, paymentMethods: [PIX], status: "Online", updatedAt: "2026-07-27T12:58:00Z" },

  // --- Merchant Buy ads (shown under the taker's "Sell" tab) ---
  { id: "AD-1015", merchantId: "m-kenyastar", asset: "USDT", direction: "Buy", fiatCurrency: "KES", pricing: fixed(129.8), minTrade: 39, maxTrade: 4620, availableLiquidity: 40000, paymentMethods: [MPESA, EQUITY], terms: "I pay out within 10 minutes during working hours. Give me the exact M-Pesa number registered in your name — I will not send to a third party.", status: "Online", updatedAt: "2026-07-27T13:56:00Z" },
  { id: "AD-1016", merchantId: "m-westlands", asset: "USDT", direction: "Buy", fiatCurrency: "KES", pricing: floating(-0.7), minTrade: 77, maxTrade: 11500, availableLiquidity: 90000, paymentMethods: [EQUITY, KCB, IM_BANK], terms: "Equity or KCB only. I send from a business account, so the sender name will not match my display name here; that is normal and the transfer reference will carry the trade ID.", status: "Online", updatedAt: "2026-07-27T13:49:00Z" },
  { id: "AD-1017", merchantId: "m-nairobihub", asset: "USDT", direction: "Buy", fiatCurrency: "KES", pricing: fixed(129.35), minTrade: 7.7, maxTrade: 928, availableLiquidity: 8800, paymentMethods: [MPESA, POCHI], status: "Online", updatedAt: "2026-07-27T13:43:00Z" },
  { id: "AD-1018", merchantId: "m-swiftkes", asset: "USDC", direction: "Buy", fiatCurrency: "KES", pricing: floating(-0.5), minTrade: 15, maxTrade: 1530, availableLiquidity: 15000, paymentMethods: [MPESA, IM_BANK], status: "Online", updatedAt: "2026-07-27T13:36:00Z" },
  { id: "AD-1019", merchantId: "m-thika", asset: "USD1", direction: "Buy", fiatCurrency: "KES", pricing: fixed(129.1), minTrade: 12, maxTrade: 387, availableLiquidity: 3200, paymentMethods: [MPESA], status: "Online", updatedAt: "2026-07-27T13:27:00Z" },
  { id: "AD-1020", merchantId: "m-kilimanjaro", asset: "SOL", direction: "Buy", fiatCurrency: "KES", pricing: fixed(18620), minTrade: 0.54, maxTrade: 16.1, availableLiquidity: 95, paymentMethods: [MPESA], status: "Paused", updatedAt: "2026-07-25T09:44:00Z" },
  { id: "AD-1021", merchantId: "m-lagosnaira", asset: "USDT", direction: "Buy", fiatCurrency: "NGN", pricing: floating(-0.6), minTrade: 65, maxTrade: 6510, availableLiquidity: 75000, paymentMethods: [BANK_TRANSFER], status: "Online", updatedAt: "2026-07-27T13:22:00Z" },
  { id: "AD-1022", merchantId: "m-londondesk", asset: "USDC", direction: "Buy", fiatCurrency: "USD", pricing: fixed(0.998), minTrade: 1000, maxTrade: 501000, availableLiquidity: 950000, paymentMethods: [WISE, BANK_TRANSFER], status: "Online", updatedAt: "2026-07-27T13:12:00Z" },
  { id: "AD-1023", merchantId: "m-eurovault", asset: "USDT", direction: "Buy", fiatCurrency: "EUR", pricing: floating(-0.4), minTrade: 220, maxTrade: 48600, availableLiquidity: 54000, paymentMethods: [SEPA, WISE], status: "Online", updatedAt: "2026-07-27T13:08:00Z" },
  { id: "AD-1024", merchantId: "m-mumbaiupi", asset: "USDT", direction: "Buy", fiatCurrency: "INR", pricing: fixed(85.7), minTrade: 120, maxTrade: 9330, availableLiquidity: 31000, paymentMethods: [UPI], status: "Online", updatedAt: "2026-07-27T13:01:00Z" },
  { id: "AD-1025", merchantId: "m-saopix", asset: "USDC", direction: "Buy", fiatCurrency: "BRL", pricing: floating(-0.8), minTrade: 54, maxTrade: 8070, availableLiquidity: 12700, paymentMethods: [PIX], status: "Online", updatedAt: "2026-07-27T12:52:00Z" },
  { id: "AD-1026", merchantId: "m-londondesk", asset: "SOL", direction: "Sell", fiatCurrency: "USD", pricing: fixed(146.1), minTrade: 0.68, maxTrade: 684, availableLiquidity: 3200, paymentMethods: [WISE, REVOLUT], status: "Online", updatedAt: "2026-07-27T12:45:00Z" },
];

/** The current merchant's own ads (merchant console, /ads). */
export const MY_ADS: Advertisement[] = [
  { id: "AD-2001", merchantId: "m-you", asset: "USDT", direction: "Sell", fiatCurrency: "KES", pricing: fixed(132.2), minTrade: 23, maxTrade: 2270, availableLiquidity: 12400, paymentMethods: [MPESA, EQUITY], status: "Online", updatedAt: "2026-07-27T12:30:00Z" },
  { id: "AD-2002", merchantId: "m-you", asset: "USDT", direction: "Buy", fiatCurrency: "KES", pricing: floating(-0.6), minTrade: 38, maxTrade: 1530, availableLiquidity: 9000, paymentMethods: [MPESA, POCHI], status: "Online", updatedAt: "2026-07-27T11:15:00Z" },
  { id: "AD-2003", merchantId: "m-you", asset: "USDC", direction: "Sell", fiatCurrency: "KES", pricing: floating(0.9), minTrade: 15, maxTrade: 756, availableLiquidity: 4600, paymentMethods: [MPESA, IM_BANK], status: "Paused", updatedAt: "2026-07-26T16:40:00Z" },
  { id: "AD-2004", merchantId: "m-you", asset: "USDT", direction: "Sell", fiatCurrency: "NGN", pricing: fixed(1550), minTrade: 32, maxTrade: 1290, availableLiquidity: 8000, paymentMethods: [BANK_TRANSFER], status: "Online", updatedAt: "2026-07-25T10:05:00Z" },
];
  ...
  for (const mk of MARKETS) {
    ...
    for (let i = 0; i < nSell + nBuy; i++) {
      ...
      ads.push({
        ...
        // In the asset, like `availableLiquidity` below — not multiplied by
        // `mk.fx`, which is what made these fiat-scale. See `Advertisement`.
        minTrade: roundSig(10 + rand() * 40, 2),
        maxTrade: roundSig(500 + rand() * 4500, 3),
        availableLiquidity:
      ...
      ads.push({
        ...
        pricing:
          i % 2 === 0
            ...
            : { type: "Floating", premiumPct: Math.round(premium * 10) / 10 },
        minTrade: 10 * (1 + ((mi + i) % 5)),
        maxTrade: 25000 * (1 + (mi % 4)),
        availableLiquidity:
          asset === "SOL"
