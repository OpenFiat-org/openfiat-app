...
export const metadata: Metadata = {
  ...
  description:
    "Fiat off-ramp made simple: sell USDT, USDC, USD1, or SOL and cash out to M-Pesa, bank transfer, and local payment methods on the OpenFiat P2P exchange — escrow-protected on Solana.",
  alternates: { canonical: "/guide/sell" },
};

const STEPS: Array<[string, string]> = [
  ["Choose Sell", "Pick the crypto you want to sell (USDT, USDC, USD1, SOL) and the fiat currency you want to receive."],
  ["Pick an offer matching your amount", "Compare buyer prices and limits the same way buyers compare sellers — check completion rate and order count."],
  ...
  ["Verify the funds in YOUR account", "Log in to your own bank or M-Pesa and confirm the money actually arrived — never trust screenshots alone."],
  ...
  return (
    <section>
      <PageHero
        ...
        description="Cash out your stablecoins to local currency safely. Sell USDT, USDC, USD1, or SOL and receive M-Pesa, bank transfer, and dozens of local payment methods — escrow-protected on Solana."
      />
